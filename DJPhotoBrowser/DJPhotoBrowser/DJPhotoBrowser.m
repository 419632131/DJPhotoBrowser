...
- (void)image:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo;
{
    ...
    if (error) {
        label.text = DJPhotoBrowserSaveImageFailText;
    }   else {
        label.text = DJPhotoBrowserSaveImageSuccessText;
    }
...
- (void)setupScrollView
{
    ...
    for (int i = 0; i < self.imageCount; i++) {
        DJBrowserImageView *imageView = [[DJBrowserImageView alloc] init];
        imageView.tag = i;
...
{
    DJBrowserImageView *imageView = _scrollView.subviews[index];
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    DJBrowserImageView *currentImageView = (DJBrowserImageView *)recognizer.view;
...
{
    DJBrowserImageView *imageView = (DJBrowserImageView *)recognizer.view;
    CGFloat scale;
    ...
    DJBrowserImageView *view = (DJBrowserImageView *)recognizer.view;
...
- (void)layoutSubviews
{
    ...
    CGFloat y = 0;
    CGFloat w = _scrollView.frame.size.width - DJPhotoBrowserImageViewMargin * 2;
    CGFloat h = _scrollView.frame.size.height;
    
    
    
    [_scrollView.subviews enumerateObjectsUsingBlock:^(DJBrowserImageView *obj, NSUInteger idx, BOOL *stop) {
        CGFloat x = DJPhotoBrowserImageViewMargin + idx * (DJPhotoBrowserImageViewMargin * 2 + w);
    ...
    _saveButton.center = CGPointMake(self.bounds.size.width * 0.5, self.bounds.size.height - 35);
}
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(UIView *)object change:(NSDictionary *)change context:(void *)context
{
    if ([keyPath isEqualToString:@"frame"]) {
        ...
        DJBrowserImageView *currentImageView = _scrollView.subviews[_currentImageIndex];
        if ([currentImageView isKindOfClass:[DJBrowserImageView class]]) {
